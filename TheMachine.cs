                ...
                while (true)
                {
                    ...
                    switch (temp)
                    {
                        case 1:
                            ...
                            TransactionList += current.DepositMoney();
                            break;

                        case 2:
                            //choice of money withdrawl
                            TransactionList += current.WithdrawMoney();
                            break;
                        ...
                        case 3:
                            ...
                            {
                                current.TransferMoney(AllAccounts[temp], out userTrans, out benTrans);
                                if (userTrans.Length!= 0) TransactionList += userTrans;
                                if (benTrans.Length != 0) TransactionList += benTrans;
                            }
                            break;
